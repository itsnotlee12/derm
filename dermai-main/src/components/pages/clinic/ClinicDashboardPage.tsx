...
export default function ClinicDashboardPage() {
  ...
  const clinicLogo = useMemo(() => {
    try {
      const raw = localStorage.getItem("dermai_clinic_settings");
      return raw ? (JSON.parse(raw) as { logo?: string }).logo || "" : "";
    } catch {
      return "";
    }
  }, []);
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
              ...
              >
                ...
                <div className="flex items-center gap-2 mt-auto w-full">
                  <Link
                    ...
                    className="flex-1 bg-[#c0166a] hover:bg-[#a01258] text-white text-xs font-semibold py-2 rounded-xl transition-colors text-center"
                  >
                    Schedule Date & Time
                  </Link>
        ...
        >
          ...
          <div className="bg-white border border-gray-100 rounded-2xl p-6">
              ...
              {[
                ...
                <div key={step} className="flex items-start gap-4">
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center shrink-0 text-sm font-bold ${
                    done ? "bg-green-100 text-green-600" : verificationStatus === "rejected" && step === 2 ? "bg-red-100 text-red-500" : "bg-gray-100 text-gray-400"
                  }`}>
            ...
            <Link
              to="/clinic/settings"
              className="mt-5 flex items-center justify-center gap-2 w-full py-3 rounded-xl bg-[#c0166a] text-white text-sm font-semibold hover:bg-[#a01259] transition-colors"
            >
